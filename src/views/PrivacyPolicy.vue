...
<template>
	<div class="page">
		<div class="center">
			...
			1. Informacje ogólne
			Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: royal-vip-poland.com
			Operatorem serwisu oraz Administratorem danych osobowych jest: Royal Fashion Vipol Sp. z o.o. Warszawa UL. ALEJE JEROZOLIMSKIE 214 02-486 WARSZAWA
			Adres kontaktowy poczty elektronicznej operatora: dorotawalkowska784@gmail.com
